            ...
            {socialLinks.map((social) => {
              ...
              return (
                <a
                  ...
                  className="flex items-center gap-3 px-6 py-4 bg-white border border-gray-200 rounded-lg hover:border-secondary transition-all group"
                >
                  <Icon className="w-6 h-6 text-secondary/80 group-hover:text-primary transition-colors" />
