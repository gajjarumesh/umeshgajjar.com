    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          author: blog.author || 'Umesh Gajjar',
        });
      } else {
      ...
      <AdminLayout>
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <p className="text-fontColor/70">Loading blog...</p>
          </div>
        </div>
      </AdminLayout>
    );
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-fontColor">Edit Blog Post</h1>
              <p className="text-fontColor/70 mt-1">Make changes to your blog post</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <Button
              ...
              disabled={deleting}
              className="text-red-600 border-red-200 hover:bg-red-50 inline-flex items-center gap-2"
            >
              {deleting ? (
        ...
        {/* Status Indicator */}
        <div className="bg-white rounded-2xl p-4 border border-secondary/20">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <span className="text-sm font-medium text-fontColor">Status:</span>
              <span
